<aside class="span4 padded">
	...
	if ( $post->ID == 15 || in_array( $post->ID, get_child_ids_array( 15 ) ) ) : ?>
	...
	if ( $post->ID == 2 || in_array( $post->ID, get_child_ids_array( 2 ) ) ) : ?>
	...
	if ( $company || $companyChildren || $newsPost || $post->post_type == 'careers'): ?>
		<ul class="sidebar-submenu unstyled margin-btm">
	...
	if ( ($post->ID == -9999 && $post->post_type == 'page') || $post->post_type == 'tribe_events' ) :
